...
1. Click `Use model`. 
2. Click `Build intelligent automations`. </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/13_launch_flow.gif) </br></br>
3. Make sure that you are signed into Power Automate. When the Power Automate view finishes loading, it would show which **Data verse** instance the flow will be connected to. Click `Continue`. </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/14_load_automate.gif) </br></br>
4. **Power Automate** will load the flow, already configured to run manually. The object detection model will be already integrated within the flow.  </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/15_load_configured_flow.gif) </br></br>
5. It is possible to click each step within the flow, view the settings and make changes to the description. There is also **MS Copilot assistant** available to make changes to the flow. (To keep the experiment simple, only the description text in **"Detect and count objects in images"** step has been changed). </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/16_overviewing_flow-setup.gif) </br></br>
6. To see it in action, click `Save` on top right corner. </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/17_save_flow.gif) </br></br>
7. Click `Test`. Under **Test flow** side panel, check `Manually` and then click `Test`. </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/18_test_flow.gif) </br></br>
9. When the side panel changes into **Run flow**, click `Import` and select a test image. They can be found [here](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/sample-data/ObjectDetection_GreenTea.zip) under the folder **test**. </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/19_load_test_image.gif) </br></br>
10. Click `Run Flow`. If the flow runs successfully, it would show the status and will extract the needed data. It will prompt to navigate toward **Flow Runs Pages** to  monitor it. </br></br> ![image](https://github.com/Nazarah/ms-powerplatform-aibuilder-object-detection/blob/main/images/20_run_flow.gif) </br></br>
